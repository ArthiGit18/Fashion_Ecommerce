...
export default function Footer() {
    return (
        <footer className=" pt-10 pb-6 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                {/* Logo and About */}
                <div>
                    <img src="./images/logo/fox (2).png" alt="logo" className='h-20 w-30' />
                    <p className="text-sm ">
                ...
                <div>
                    ...
                    <div className="flex gap-4">
                        <a href="#" className="hover:text-blue"><FacebookIcon /></a>
                        <a href="#" className="hover:text-blue"><TwitterIcon /></a>
                        <a href="#" className="hover:text-blue"><InstagramIcon /></a>
                        <a href="#" className="hover:text-blue"><LinkedInIcon /></a>
                    </div>
                </div>
            </div>
